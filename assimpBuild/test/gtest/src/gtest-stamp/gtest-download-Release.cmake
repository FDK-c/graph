...
set(command "D:/graph/cmake-3.25.0-windows-x86_64/bin/cmake.exe;-P;D:/graph/assimpBuild/test/gtest/tmp/gtest-gitclone.cmake")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "D:/graph/assimpBuild/test/gtest/src/gtest-stamp/gtest-download-out.log")
set(stderr_log "D:/graph/assimpBuild/test/gtest/src/gtest-stamp/gtest-download-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  D:/graph/assimpBuild/test/gtest/src/gtest-stamp/gtest-download-*.log")
  endif()
  ...
  if(NOT "Visual Studio 16 2019" MATCHES "Ninja")
    set(msg "gtest download command succeeded.  See also D:/graph/assimpBuild/test/gtest/src/gtest-stamp/gtest-download-*.log")
    message(STATUS "${msg}")
  endif()
endif()
